...
-- (1972,"Economics","Joseph","Russia","Economist"),(1973,"Biology","Philips","USA","Prime Minister"),(1980,"Biology","Martin","USA","President"),(1981,"Physiology","Hannah","Hungary","Scientist"),(1975,"Physics","Peter","Chile","Scientist");
-- SELECT * FROM NOBEL_WIN
-- SELECT * FROM NOBEL_WIN WHERE SUBJECT NOT LIKE "P%"
-- SELECT * FROM NOBEL_WIN WHERE CATEGORY LIKE "Linguist%"